<script>
    /* original by https://github.com/efeskucuk/svelte-color-picker/blob/master/src/HsvPicker.svelte */
    ...
    <style>
    .main-container {
        @apply bg-gray-800 text-white w-240px h-204px rounded-sm shadow select-none;
    }
    .saturation-gradient {
        @apply w-240px h-160px;
        background: linear-gradient(to right, rgb(255, 255, 255), rgba(255, 255, 255, 0));
    }
    .value-gradient {
        @apply overflow-hidden w-240px h-160px;
